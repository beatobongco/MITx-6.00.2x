...
class RectangularRoom(object):
  ...
  def getNumCleanedTiles(self):
    ...
    returns: an integer
    """
    # Just returns number of True values
  ...
  def getRandomPosition(self):
    ...
    """
    random_key = random.choice(list(self.tiles.keys()))

    return Position(random_key[0], random_key[1])
...
print(runSimulation(3, 1.0, 25, 25, 0.75, 1, RandomWalkRobot))
...
#   plot.
#
showPlot1('Time taken by # robots to clean 80% of room', 'No. robots', 'Steps taken')

#
# 2) Write a function call to showPlot2 that generates an appropriately-labeled
#   plot.
#
showPlot2('Time taken by 2 robots to clean rooms with different aspect ratios', 'Aspect ratio', 'Steps taken')
